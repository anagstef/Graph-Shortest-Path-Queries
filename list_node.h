...
#include <iostream>
#include <cstdint>
#define N 15 //the size of the static array on each list node
...
public:
    ...
    uint32_t* get_propertyArray() { return  edgeProperty; }
    void set_neighbor(int i, uint32_t value, uint32_t version);
